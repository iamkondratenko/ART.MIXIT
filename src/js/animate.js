...
export default function animate() {
  ...
  if ($('.main-hero').length) {
    ...
    tl.fromTo('.hero-arrow', 0.5, {
        opacity: 1
      }, {
        opacity: 0
      }, '-=1.3')
      .fromTo(".main-hero-head-fuck", 4, {
        top: 300
      }, {
        top: 0
      }, '-=1')
      .fromTo(".main-hero-head-makeup", 2, {
        x: -400
      }, {
        x: 0
      }, '-=3.5')
      .fromTo(".main-hero-head-makeup", 4, {
        top: 800
      }, {
        top: 0
      }, '-=4')
      .fromTo(".main-hero-head-standards", 4, {
        top: 800
      }, {
        top: 0
      }, '-=4')
  ...
  if ($('.main-hero-nav').length) {
    ...
    tlNav.fromTo(".main-hero-nav-list", 2, {
        y: 200
      }, {
        y: 0
      })
      .fromTo(".main-hero-bottom-first", 2, {
        y: 200
      }, {
        y: 0
      }, '-=1.5')
      .fromTo(".main-hero-bottom-middle", 2, {
        y: 400
      }, {
        y: 0
      }, '-=1.5')
  ...
  if ($('.main-bundle-title').length) {
    ...
    tlBundle.fromTo(".h2-multiple", 2, {
      ...
      .fromTo(".h2-multiple .h2-outline", 2, {
        x: 600,
        opacity: 0
      }, {
        x: 0,
  ...
  const scene = new ScrollMagic.Scene({
      triggerElement: '.main-product-list-item'
    })
    .setPin(console.log('xs'))
